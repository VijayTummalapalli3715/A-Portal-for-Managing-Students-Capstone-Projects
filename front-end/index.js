...
const app = express();
const PORT = process.env.FRONTEND_PORT || 4000; // Default to 4000 if not set

// Inject backend URL into all EJS templates
app.use((req, res, next) => {
    res.locals.BACKEND_URL = process.env.BACKEND_URL || "http://localhost:5006";
    next();
});
